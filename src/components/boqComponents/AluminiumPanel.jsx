...
const AluminiumPanels = () => {
  ...
  const totalAmount = savedData?.panelData.reduce((total, data) => {
    const material = aluminiumRows.find((row) => row._id === data.materialId);
    if (material) {
              ...
              <TableBody>
                ...
                {aluminiumRows.map((row) => (
                  ...
                  >
                    ...
                    <StyledTableCell align="right">{row.unit}</StyledTableCell>
                   <StyledTableCell align="right">
                  {savedData?.panelData !== null ? (
                    <Box>
          
                      {savedData?.panelData.map((data) => {
...
export default AluminiumPanels;
