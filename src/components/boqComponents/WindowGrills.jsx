...
const savedInfo = JSON.parse(localStorage.getItem("savedData"));
  ...
  const totalAmount = savedData?.grillData.reduce((total, data) => {
    const material = grillsRows.find((row) => row._id === data.materialId);
    if (material) {
              ...
              <TableBody>
                ...
                {grillsRows.map((row) => (
                  ...
                  >
                    ...
                    <StyledTableCell align="right">{row.unit}</StyledTableCell>
                     <StyledTableCell align="right">
                  {savedData?.grillData !== null ? (
                    <Box>
          
                      {savedData?.grillData.map((data) => {
