...
//           API_BASE_URL + `/api/savedwaterIn/${savedInfo.savedPreId}`,
//           config
//         );
...
//       try {
//         const response = await axios.put(
//           API_BASE_URL + `/api/savedwaterIn/${savedData._id}`,
//           {
...
//   const totalAmount = savedData?.waterInsideData.reduce((total, data) => {
...
//                     <StyledTableCell align="right">{row.unit}</StyledTableCell>
//                     <StyledTableCell align="right">
//                       {savedData?.waterInsideData !== null ? (
//                         <Box>
//                           {savedData?.waterInsideData.map((data) => {
