...
const GypsumCeiling = () => {
  ...
  const [gypsumRows , setGypsumRows ] = useState([]);
  // edit rate useState
  ...
  const totalAmount = savedData?.gypsumData.reduce((total, data) => {
    const material = gypsumRows.find((row) => row._id === data.materialId);
    if (material) {
...
<StyledTableCell align="center">
                  {savedData?.gypsumData !== null ? (
                    <Box>
          
                      {savedData?.gypsumData.map((data) => {
