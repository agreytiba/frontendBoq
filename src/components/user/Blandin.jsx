...
const Blandin = () => {
  ...
  const columns = [
    {
      ...
      renderCell: (params) => (
        <Button
          variant="outlined"
          onClick={() => handleViewPreData(params.row.outsideData)}
        >
          Blanderind outside
        </Button>
      ),
  ...
  const handleViewPreData = (outsideData) => {
    setSelectedPreData(outsideData);
    setOpenDialog(true);
  };
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('Substructure Blandering Outside', 10, 10);
