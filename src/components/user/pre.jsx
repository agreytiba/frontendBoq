...
const Pre = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('Preliminaries Data', 10, 10);
    ...
    <Box display={"flex"} justifyContent={"center"} alignItems={"center"}>
      <Box width={"80%"} sx={{
        ...
        <Dialog open={openDialog} onClose={handleCloseDialog}>
          <DialogTitle style={{ textAlign: "center", backgroundColor: "goldenrod", color: "#fff" }}>Preliminaries</DialogTitle>
          <DialogContent>
            <TableContainer>
              <Table>
                <TableHead>
