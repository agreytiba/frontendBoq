...
const Concrete = () => {
  ...
  const columns = [
    {
      ...
      renderCell: (params) => (
        <Button
          variant="outlined"
          onClick={() => handleViewPreData(params.row.concreteData)}
        >
          Concrete foundation
        </Button>
      ),
  ...
  const handleViewPreData = (concreteData) => {
    setSelectedPreData(concreteData);
    setOpenDialog(true);
  };
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('Substructure over   site concrete', 10, 10);
      ...
      <Box width={"80%"} sx={{
        ...
        <DataGrid rows={savedPres} columns={columns} pageSize={5} getRowId={getRowId} />
              ...
              <Dialog open={openDialog} >
                  ...
                  }}>Substructure Site Concrete</DialogTitle>
          <DialogContent>
            <TableContainer>
              <Table>
                <TableHead>
