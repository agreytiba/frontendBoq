...
const WallFound = () => {
  ...
  useEffect(() => {
    const fetchSavedPres = async () => {
      try {
        const response = await axios.get('https://backendboq.onrender.com/api/savedwallfoundations');
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('Substructure foundation walls', 10, 10);
      ...
      <Box width={"80%"} sx={{
        ...
        <DataGrid rows={savedPres} columns={columns} pageSize={5} getRowId={getRowId} />
              ...
              <Dialog open={openDialog} >
                  ...
                  }}>Substructure  foundation walls</DialogTitle>
          <DialogContent>
            <TableContainer>
              <Table>
                <TableHead>
